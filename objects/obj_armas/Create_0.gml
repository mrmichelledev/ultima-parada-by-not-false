...
ds_map_add(armas[0], "municaoMax", 0)
...
ds_map_add(armas[2], "projetil", spr_escopetaB)
ds_map_add(armas[2], "muzzle", m_6)
ds_map_add(armas[2], "xProjetil", 59)
ds_map_add(armas[2], "yProjetil", 9)
ds_map_add(armas[2], "municao", 30)
ds_map_add(armas[2], "municaoMax", 30)
ds_map_add(armas[2], "som", sn_Escopeta)
ds_map_add(armas[2], "velocidade", 15)
ds_map_add(armas[2], "recuo", 40)
ds_map_add(armas[2], "dano", 10)
...
ds_map_add(armas[3], "projetil", spr_metralhadoraB)
